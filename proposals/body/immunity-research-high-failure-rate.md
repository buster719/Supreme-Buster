# Body Upgrade Proposal: immunity research-high-failure-rate

## Metadata

- Proposal ID: immunity-research-high-failure-rate
...
Research ledger failure ratio is 66% across 207 entries.
...
Split research failure statuses, pause scientific follow-up on synthesis failures, and require evidence relevance checks before spending synthesis calls.
